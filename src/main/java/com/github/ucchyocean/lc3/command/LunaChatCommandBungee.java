...
public class LunaChatCommandBungee extends LunaChatCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        execute(ChannelMember.getChannelMember(sender), "ch", args);
    }
    ...
    public Iterable<String> onTabComplete(CommandSender sender, String[] args) {
        return onTabComplete(ChannelMember.getChannelMember(sender), "ch", args);
    }
     ...
     * @param pre 検索キー
     * @return プレイヤー名リスト
     * @see com.github.ucchyocean.lc3.command.LunaChatCommand#getListPlayerNames(java.lang.String)
     */
    @Override
